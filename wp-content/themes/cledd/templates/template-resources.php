...
$cledd_trcho_feature_post = $fields['cledd_trcho_feature_post']; ?>
...
<section id="hero-section" class="hero-section">
	<div class="blog-hero">
		<div class="wrapper">
			...
			<?php
			global $post;
			if($cledd_trcho_feature_post){ ?> <?php foreach ($cledd_trcho_feature_post as $key => $feature_post) {
				$post 			= $feature_post;
				setup_postdata( $post );
				$pID         	= $post->ID;
	...
	<div class="wrapper">
		<div class="rc-post-archive three-columns"> <?php
			...
			$args = array(
				...
				// 'meta_key' => 'cledd_trcho_feature_post',
				'posts_per_page'         => 9, //how many posts you need
				'paged' => ( get_query_var('paged') ? get_query_var('paged') : 1),
				// 'meta_query' => array(
				// 	array(
				// 		'key'     => 'cledd_trcho_feature_post',
				// 		'value'   => '1',
				// 		'compare' => '!=',
				// 	)
				// ),
