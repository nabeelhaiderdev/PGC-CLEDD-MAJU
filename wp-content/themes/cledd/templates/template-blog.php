...
$cledd_tblgho_feature_post 	= $fields['cledd_tblgho_feature_post'];
$cledd_author_avatar 		= $fields['cledd_author_avatar'];
$cledd_pagetitle = (isset($fields['cledd_tblgho_title']) && $fields['cledd_tblgho_title']!='' ) ? $fields['cledd_tblgho_title'] : get_the_title();

// $categories=get_categories(array(
// 	'hide_empty' 	=> false,
// ));

$cledd_post_catagories = get_categories($pID);
// var_dump($cledd_post_catagories);
	...
	<div class="wrapper">
		...
		<div class="blog-nav">
			<div class="nav-ctn d-flex justify-content-center flex-wrap">
				<?php if($cledd_post_catagories){ ?>
					<ul>
						<?php foreach ($cledd_post_catagories as $category ) { ?>
		...
		<?php
		global $post;
		if($cledd_tblgho_feature_post){ ?> <?php foreach ($cledd_tblgho_feature_post as $key => $feature_post) {
			$post = $feature_post;
			setup_postdata( $post );
			$pID         = $post->ID;
			...
			$author_avatar = ($cledd_author_avatar)? $cledd_author_avatar : get_avatar_url($pID);
