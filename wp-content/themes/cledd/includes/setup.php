...
if ( ! function_exists( 'glide_setup_function' ) ) {
	...
	function glide_setup_function() {
		...
		load_theme_textdomain( 'cledd_td' );
...
function glide_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      => array(
            'page_title'                      => __( 'Install Required Plugins', 'cledd_td' ),
            'menu_title'                      => __( 'Plugin Installer', 'cledd_td' ),
            'installing'                      => __( 'Installing Plugin: %s', 'cledd_td' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'cledd_td' ),
            ...
            'return'                          => __( 'Return to Required Plugins Installer', 'cledd_td' ),
            'plugin_activated'                => __( 'Plugin activated successfully.', 'cledd_td' ),
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'cledd_td' ), // %s = dashboard link.
