...
function glide_blocks_category( $categories ) {
	$custom_block = array(
		'slug'  => 'glide-blocks',
		'title' => __( 'Glide Blocks', 'cledd_td' ),
		'icon'  => 'glide-blocks',
	);
...
if ( function_exists( 'acf_add_options_page' ) ) {
	$option_page = acf_add_options_page(
		array(
			'page_title' => __( 'Theme Options', 'cledd_td' ),
			'menu_title' => __( 'Theme Options', 'cledd_td' ),
...
function wysiwyg_render_field_settings( $field ) {
	acf_render_field_setting(
		$field,
		array(
			'label'        => __( 'Height of Editor', 'cledd_td' ),
			'instructions' => __( 'Height of Editor after Init', 'cledd_td' ),
			'name'         => 'wysiwyg_height',
			'type'         => 'number',
		)
	);
