...
$title                             = get_the_title();
$cledd_cpt_team_designation = $block_fields['cledd_cpt_team_designation'];
$cledd_cpt_team_text        = html_entity_decode( $block_fields['cledd_cpt_team_text'] );
?>
...
<article <?php post_class( 'single-member column' ); ?>>
			...
			<div class="single-team">
				<div class="single-team-head d-flex flex-wrap justify-content-between align-items-center">
					...
					<div class="member-detail-popup">
						...
						<?php } ?>
						<?php if ( $cledd_cpt_team_designation ) { ?>
							<h5 class="member-designation"><?php echo $cledd_cpt_team_designation; ?></h5>
						<?php } ?>
					</div>
				</div>
				<?php if ( $cledd_cpt_team_text ) { ?>
					<div class="single-team-content"><?php echo $cledd_cpt_team_text; ?></div>
				<?php } ?>
			</div>
		</div>
	</div>
	<a class="sm-inner open-popup-link" href="#post-<?php the_ID(); ?>">
		...
		<div class="t-detail">
			...
			<?php } ?>
			<?php if ( $cledd_cpt_team_designation ) { ?>
				<h5 class="designation"><?php echo $cledd_cpt_team_designation; ?></h5>
			<?php } ?>
		</div>
	</a>
